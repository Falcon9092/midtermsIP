...
public class Drawing extends JComponent{
	...
	public Drawing(){
		...
		monster3 = new Monster(300, 300);
		monster4 = new Monster(200, 200);
		monster5 = new Monster(300, 200);
		monster6 = new Monster(300, 300);
		monster7 = new Monster(200, 200);
		monster8 = new Monster(300, 200);
		monster9 = new Monster(300, 300);
		monster10 = new Monster(200, 200);
		monster11 = new Monster(300, 200);
		monster12 = new Monster(300, 300);
		monster13 = new Monster(200, 100);
		monster14 = new Monster(300, 200);
		monster15 = new Monster(200, 300);
		...
		for(int x=0; x<monsters.length; x++){
			...
			if(monsters[x]!=null){
				...
				if(yChecker > monsters[x].yPos){
					if(yChecker-monsters[x].yPos < monsters.height){
						collideY = true;
					}
				}
				else{
